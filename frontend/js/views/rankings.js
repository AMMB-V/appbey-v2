        ...
        <tr onclick="window.openRankingsBladerModal(${idx})" class="hover:bg-slate-800/60 cursor-pointer transition">
          ...
          <td class="py-3 px-2 sm:px-3 font-sans">
            <div class="flex items-center gap-2.5">
              <img src="/assets/images/appbey_official_logo.png?v=3.1" class="w-8 h-8 rounded-full object-cover border ${borderClass} shrink-0 shadow" alt="${bladerName}"/>
              <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
              ...
              <div class="glass-card rounded-2xl p-6 text-center border border-slate-600 md:order-1 flex flex-col justify-between space-y-3 bg-gradient-to-b from-slate-800/40 to-slate-950/80">
                ...
                <div class="relative inline-block mx-auto">
                  <img src="/assets/images/appbey_official_logo.png?v=3.1" class="w-20 h-20 rounded-full border-4 border-slate-400 mx-auto object-cover shadow-lg" alt="${top3[1].display_name || '2do Lugar'}"/>
              ...
              <div class="glass-card rounded-2xl p-6 text-center border-2 border-amber-400 glow-gold md:order-2 flex flex-col justify-between space-y-3 bg-gradient-to-b from-amber-950/50 via-slate-900 to-slate-950">
                ...
                <div class="relative inline-block mx-auto">
                  <img src="/assets/images/appbey_official_logo.png?v=3.1" class="w-24 h-24 rounded-full border-4 border-amber-400 mx-auto object-cover shadow-2xl" alt="${top3[0].display_name || '1er Lugar'}"/>
              ...
              <div class="glass-card rounded-2xl p-6 text-center border border-amber-700/60 md:order-3 flex flex-col justify-between space-y-3 bg-gradient-to-b from-amber-950/30 to-slate-950/80">
                ...
                <div class="relative inline-block mx-auto">
                  <img src="/assets/images/appbey_official_logo.png?v=3.1" class="w-20 h-20 rounded-full border-4 border-amber-700 mx-auto object-cover shadow-lg" alt="${top3[2].display_name || '3er Lugar'}"/>
      ...
      modalEl.innerHTML = `
        <div class="glass-card w-full max-w-lg rounded-2xl border border-slate-700 p-6 space-y-5 bg-slate-900 shadow-2xl relative" onclick="event.stopPropagation()">
          ...
          <div class="flex items-center gap-4">
            <div class="relative">
              <img src="/assets/images/appbey_official_logo.png?v=3.1" class="w-16 h-16 rounded-full border-2 border-amber-400 object-cover shadow-lg" alt="${name}"/>
